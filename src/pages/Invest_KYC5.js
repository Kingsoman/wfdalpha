          ...
          <Box width='900px' bg='#FFFFFF0D' px='50px' style={{fontFamily:'Sk-Modernist'}} >
            ...
            <Flex mt='83px' justify='center' align='center' direction='column'
              style={{fontFamily:'PilatExtended'}}>
                ...
                <Text fontSize='22px' fontWeight={'300'} fontFamily={'Pilat Extended'}>Facial Identification</Text>
                <Text fontSize='16px' color='rgba(255, 255, 255, 0.54)' fontWeight={'normal'} mt={'20px'} textAlign={'center'} maxW={'465px'} lineHeight={'140%'} fontFamily={'Sk-Modernist'} mt={'15px'} mb={'15px'}>
                    We would like to confirm your facial identification. Face the camera and ensure your face within the frame. Turn around to ensure all angle are captured
                </Text>
                
            <Flex direction={'column'}>
              <Image alignSelf={'center'} mt={'25px'} mb={'25px'} alt={'WeFund'} src={ 'selfie.svg' } />
              
              {/* -----------------Next and back----------------- */}
            <Flex 
              direction={{base: 'column',md: 'column',lg: 'row',}} mt='10px' >
              <Flex 
