      ...
      width:'100%', color:'white', fontSize:'18px', fontFamily:'Sk-Modernist-Regular', fontWeight:'500' }}>
        ...
        <Flex width='100%' justify='center' mt='80px' px='175px'>
          <Box width='900px' bg='#FFFFFF0D' px='50px' style={{fontFamily:'Sk-Modernist-Regular'}} >
            ...
            <Flex mt='83px' justify='center' align='center' direction='column'
              style={{fontFamily:'PilatExtended'}}>
                ...
                <Text fontSize='22px' fontWeight={'300'} fontFamily={'Pilat Extended'}>Lets Get You Verified</Text>
                <Text fontSize='16px' color='rgba(255, 255, 255, 0.54)' fontWeight={'normal'} mt={'20px'} textAlign={'center'} maxW={'465px'} lineHeight={'140%'} fontFamily={'Sk-Modernist-Regular'} mt={'15px'}>
                    Before you start please prepare valid documents needed for identification
                    <br/><br/>
                    Wefund also require you to confirm your acceptance of your personal data handling by us
                </Text>
            </Flex>
          ...
          <Flex mt='25px' direction="row">
                ...
                <Text ml='10px' fontSize='14px' fontWeight='400'>I agree to all condition of the <span style={{ color: '#00A3FF' }} mb="25px">Personal Data Processing </span></Text>
              </Flex>
              {/* -----------------Next and back----------------- */}
            <Flex 
              direction={{base: 'column',md: 'column',lg: 'row',}} mt='50px' minHeight={'800px'}>
              <Flex 
